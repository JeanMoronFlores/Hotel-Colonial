    ...
    public void ReporteClientes(){
     Document documento = new Document();
        try {
            ...
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "C:/Users/JEAN/Desktop/Reporte_Clientes.pdf"));// hayq e tener mucho cuidado aqui no s epeude encontrar las rutas coreretas
    ...
    * metodo para crear reportes de los productos registrados en el sistema
    ...
    public void ReportesProductos() {
        ...
        try {
            ...
            Image header = Image.getInstance("Imagenes/LogoColonialMono 100X100.png");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
            Paragraph parrafo = new Paragraph();
